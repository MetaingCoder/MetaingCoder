...
|---------|-------------|------|
| **Web Dashboard** | A dynamic dashboard for monitoring web app stats, built with Vue & Node.js | [GitHub](https://github.com/MetaingCoder/web-dashboard) |
| **Portfolio Site** | Personal portfolio site to showcase projects & skills | [GitHub](https://github.com/MetaingCoder/portfolio) |
| **Task Manager API** | RESTful API for task management with Node.js & MySQL | [GitHub](https://github.com/MetaingCoder/task-manager-api) |
...
### **💬 Quote**
> “Code is like poetry, write it beautifully and it speaks for itself.”